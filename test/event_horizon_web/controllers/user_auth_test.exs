defmodule EventHorizonWeb.UserAuthTest do
  use EventHorizonWeb.ConnCase, async: true

  alias EventHorizon.Accounts
  alias EventHorizonWeb.UserAuth
  import EventHorizon.AccountsFixtures

  @remember_me_cookie "_event_horizon_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, EventHorizonWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      EventHorizonWeb.Endpoint.subscribe(live_socket_id)
